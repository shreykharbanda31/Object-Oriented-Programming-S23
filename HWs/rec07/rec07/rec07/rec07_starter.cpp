...
bool Registrar::enrollStudentInCourse(const string& studentName,
                           const string& courseName){
    return students[findStudent(studentName)]->addCourse(courses[findCourse(courseName)]) && courses[findCourse(courseName)]->addStudent(students[findStudent(studentName)]);
