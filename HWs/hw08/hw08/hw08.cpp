...
//  hw08
//
//  Created by Shrey Kharbanda on 4/19/23.
//
...
int main() {
    ...
    //test the evaluaton
    int x = 5;
    cout << "Evaluating p1 at " << x << " yields: " << p1.eval(5) << endl;
    cout << "Evaluating p2 at " << x << " yields: " << p2.eval(5) << endl;

    Polynomial p7({3, 2, 1});           // 3x^2 + 2x + 1
    cout << "p7: " << p7 << endl;
    cout << "Evaluating p7 at " << x << " yields: " << p7.eval(5) << endl;
